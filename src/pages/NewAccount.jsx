  ...
  return (
    <div className="bg-white mt-5 max-w-md mx-auto p-5 shadow-lg rounded-sm">
      <form method="post" onSubmit={handleSubmit(onSubmit)}>
        ...
        {/* Repeat Password */}
        <div className="mb-5">
          <label htmlFor="repeadPassword" className="block mb-1 text-sm">
            Repead Password
          </label>
          <input
            type="password"
        ...
        <div className="md-5 flex">
          ...
          <label htmlFor="agree" className="ml-1.5 text-xs">
        ...
        <div className="mb-5 flex text-xs items-center gap-1 justify-center">
          ...
          <div>
            <Link to="/login">
              <button className=" cursor-pointer text-blue-400">login</button>
            </Link>
          </div>
        </div>
      </form>
